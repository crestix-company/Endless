...
export const metadata: Metadata = {
  metadataBase: new URL('https://cut-club-endless.s-nishita.chatgpt.site'),
  ...
  openGraph: { type: 'website', locale: 'ja_JP', title: 'カット倶楽部エンドレス', description: '亘理で17年。一席だけの、あなたの理容室。', url: 'https://cut-club-endless.s-nishita.chatgpt.site' },
};
const salon = { '@context': 'https://schema.org', '@type': 'HairSalon', name: 'カット倶楽部エンドレス', url: 'https://cut-club-endless.s-nishita.chatgpt.site', telephone: '+81-223-32-2708', address: { '@type': 'PostalAddress', addressRegion: '宮城県', addressLocality: '亘理郡亘理町', streetAddress: '字新井町7-5', addressCountry: 'JP' }, hasMap: 'https://www.google.com/maps/search/?api=1&query='+encodeURIComponent('カット倶楽部エンドレス 宮城県亘理郡亘理町新井町7-5') };
